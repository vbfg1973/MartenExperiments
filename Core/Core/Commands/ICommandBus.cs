namespace Core.Commands
{
    public interface ICommandBus
    {
        ...
        /// <returns></returns>
        Task Send<TCommand>(TCommand command, CancellationToken ct = default) where TCommand : DomainCommandBase;
        ...
        Task<bool> TrySend<TCommand>(TCommand command, CancellationToken ct = default)
